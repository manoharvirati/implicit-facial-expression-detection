...
MODEL_PATH = "D:\\projectcv\\cnnVersion2\\projectcnn_face_expression\\projectcnn_face_expression\\support\\model.h5"
EPOCHS = 5
...
def trainModel():
    ...
    global trainX, valX, testX, trainY, valY, testY, TRAIN_PERCENT #, VALIDATION_PERCENT

    """while(True):
        TRAIN_PERCENT = TRAIN_PERCENT+10
        #VALIDATION_PERCENT = VALIDATION_PERCENT+10
        if(TRAIN_PERCENT == 100):
            break
        print("\nNo. of epochs = ",EPOCHS,"\nTRAIN PERCENT = ",TRAIN_PERCENT,"\nTEST PERCENT = ",(100-(VALIDATION_PERCENT+TRAIN_PERCENT)))"""
