import ckpluslayer as ck
import numpy as np
import os
import cv2

OUTPUT_DIRECTORY = "D:\\projectcv\\cnnVersion2\\projectcnn_face_expression\\projectcnn_face_expression\\Emotion Dataset"
EMOTION_DIRECTORIES = ["/0_NEUTRAL", "/1_ANGER", "/2_CONTEMPT", "/3_DISGUST", "/4_FEAR", "/5_HAPPY", "/6_SADNESS",
                       "/7_SURPRISE"]
...
def storeFacesInEmotionDir():
    """Uses ckpluslayer module to store images in the emotion directories"""
